...
import projectiles.MGProjectile;
import folder.Level;
...
public class MachineGunner extends Unit {
	...
	public MachineGunner(int x, int y, boolean playerR, boolean playerB) {
		super(x, y, playerR, playerB);
		move_range = 150;
		projectile_range = MGProjectile.getRange();
		vision_range = 100;
		vision_width = 0.8;
	...
	protected void shoot(double x, double y, double dir) {
		Projectile p = new MGProjectile(x - 8, y - 5, dir, UNIT_R, UNIT_G); 
