...
import projectiles.MedicProjectile;
...
public class Medic extends Unit {
	...
	protected final int HEAL_RANGE;

	public Medic(int x, int y, boolean playerR, boolean playerB) {
		super(x, y, playerR, playerB);
		move_range = 150;
		projectile_range = MedicProjectile.getRange();
		vision_range = 110;
		vision_width = 1;
		HEAL_RANGE = 50;
		...
		speed = .7;
		reload = 0;
		RELOAD = MedicProjectile.FIRE_RATE;
	...
	protected void shoot(double x, double y, double dir) {
		Projectile p = new MedicProjectile(x - 8, y - 5, dir, UNIT_R, UNIT_G); 
