...
public class MGProjectile extends Projectile{
	...
	public static final int FIRE_RATE = 6; //5 seems optimal. adjust for burst fireee
	private static final double RANGE = 200;
	
	public MGProjectile (double x, double y, double dir, boolean playerR,boolean playerB) {
