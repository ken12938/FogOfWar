...
public class MedicProjectile extends Projectile{

	public static final int FIRE_RATE = 150; //5 seems optimal. adjust for burst fireee
	private static final double RANGE = 150;
	
	public MedicProjectile (double x, double y, double dir, boolean playerR,boolean playerB) {
