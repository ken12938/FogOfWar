...
public class SniperProjectile extends Projectile{
	...
	public static final int FIRE_RATE = 600; //5 seems optimal. adjust for burst fireee
	private static final double RANGE = 300;
	
	public SniperProjectile (double x, double y, double dir, boolean playerR,boolean playerB) {
		super(x, y, dir, playerR, playerB);
		//arbitrary values
		range = RANGE; 
		damage = 150;
		dmgType = "bullet";
		sprite = Sprite.projectile_sniper; //sprite.grass is arbitrary
		speed = 15; //4 seems optimal 
		size = 2;
