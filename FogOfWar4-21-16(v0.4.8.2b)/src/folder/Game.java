...
public class Game extends Canvas implements Runnable{
	...
	public void updateMenu() {
		...
		/*menuinterface1.update();
		menubutton1.update();
		menubutton2.update();
		menubutton3.update();
		menutitlebutton.update();
		menutopbutton.update();
		menubottombutton.update();*/
	}
	...
	public void updateInterface() {
		...
		button5.update();
		nextbutton1.update();
		selectioninterface1.update();
		selectioninterface2.update();
		selectionbutton3.update();
		selectionbutton4.update();
		selectionbutton5.update();
		selectionbutton6.update();
		selectionbutton7.update();
		selectionbutton9.update();
		selectionbutton8.update();
		infobutton1.update();
		infobutton2.update();
		infobutton3.update();
		infobutton4.update();
		...
		nextbutton2.update();
		helpbutton1.update();
		helpinterface1.update();
		helpbutton2.update();
		helpbutton3.update();
		helpbutton4.update();
		settingsbutton1.update();
		settingsinterface1.update();
		settingsbutton2.update();*/
		
	}
	
	public void updateKeyboardInteractions() { //detects keyboard presses and updates the buttons based on them
	...
	public int gameCondition() { //detects whether red wins, green wins, tie, or game still is going
